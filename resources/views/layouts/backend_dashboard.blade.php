        ...
        <div class="d-flex">
            ...
            <nav class="side-nav">
                <a href="index.html" class="intro-x d-flex align-items-center ps-5 pt-4">
                    <h3 class="fs-2xl text-white">laravel Blog</h3>
                </a>
                        ...
                        <ul class="side-menu__sub-open">
                            ...
                            <li>
                                <a href="{{ route('category.add') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title" href=""> 
                                        Add category </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('category.sub.add') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title" href=""> 
                ...
                <div class="top-bar">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-pill overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-bs-toggle="dropdown">
                            <img alt="Rubick Tailwind HTML Admin Template" src="https://api.dicebear.com/5.x/open-peeps/svg">
                        </div>
                                ...
                                <li>
                                    <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="dropdown-item text-white bg-theme-1-hover dark-bg-dark-3-hover">
